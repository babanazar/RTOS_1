...
int main(void)
{
  ...
  osThreadDef(task2, task2Init, osPriorityAboveNormal, 0, 128);
  ...
  // define thread
  osThreadDef(task3, task3Init, osPriorityBelowNormal, 0, 128);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOJ, GPIO_PIN_0|GPIO_PIN_1, GPIO_PIN_RESET);
